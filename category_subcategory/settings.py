"""
Django settings for category_subcategory project.
...
import os
# PROJECT IMPORTS
from category_subcategory.local_settings import (
...
from category_subcategory.logging import LOGGING
from category_subcategory.juzzmin import CONFIG

PROJECT_NAME = 'category_subcategory'
...
PROJECT_APPS = [
    'Core',
    'API',
    'catagory_all.apps.CatagoryAllConfig',
]
...
ROOT_URLCONF = 'category_subcategory.urls'
...
WSGI_APPLICATION = 'category_subcategory.wsgi.application'
...
try:  # optional settings import
    from category_subcategory.local_settings import EMAIL_BACKEND
